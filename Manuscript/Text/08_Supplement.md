...
![**Full panel of predicted versus actual immune cell type responses.** Dots represent experimental measurements and shaded regions represent confidence interval for model predictions. Time of pSTAT5 activity measurement is denoted by color. All cell populations were independently stimulated with both IL-2 (A-J) or IL-15 (K-T).](./Manuscript/Figures/figureS5.svg){#fig:supp5}
