...
def input_IL2_15(final_conc, num):
    ...
    # Il2ra, Il2rb, Il2rg, Il15ra, Il7r, Il9r, IL4Ra, IL21Ra expression rates in that order. These values come from the fitting results of the IL2-15 model.
    Rexpr = np.array([3.8704, 0.734, 1.7147, 0.32010875, 0.0, 0.0, 0.0, 0.0])
