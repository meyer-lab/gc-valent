...
class IL4_7_activity:
    def __init__(self):
        ...
        dataIL7 = pds.read_csv(join(path, "./data/Gonnord_S3C.csv")).values # imports IL21 file into pandas array
    ...
    def calc(self, unkVec, scales):
        """Simulate the experiment with different ligand stimulations. Theano is making a list of promises which will be calculated and returned as output."""
