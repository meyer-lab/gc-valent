...
class build_model:
    ...
    def build(self):
        ...
        with M:
            ...
            Y_15 = unkVec  # fitting the data based on dst15.calc for the given parameters
            ...
            Y_int = unkVec  # fitting the data based on IL2Rb surface data
            ...
            Y_gc = unkVec  # fitting the data using IL2Ra- cells
