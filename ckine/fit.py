...
class build_model:
    ...
    def build(self):
        ...
        with M:
            ...
            rxnrates = pm.Lognormal('rxn', mu=np.log(0.1), sd=1, shape=10) # there are 6 reverse rxn rates associated with IL2 and IL15
            ...
            unkVec = T.concatenate((ligands, kfwd, rxnrates, endo_activeEndo, sortF, kRec_kDeg, Rexpr, T.zeros(4, dtype=np.float64))) 
