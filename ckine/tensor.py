...
def perform_decomposition(tensor, r, cell_dim):
    ...
    factors = non_negative_parafac(z_score_values(tensor, cell_dim), r, tol=1.0E-9, n_iter_max=1000000)
...
def perform_tucker(tensor, rank_list, cell_dim):
    ...
    out = non_negative_tucker(z_score_values(tensor, cell_dim), rank_list, tol=1.0E-9, n_iter_max=1000000)
    return out
