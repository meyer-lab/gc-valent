...
def dy_dt(y, t, IL2, IL7, IL9, k1fwd, k4fwd, k5rev, k6rev, k10rev, k11rev, k13rev, k14rev, k15rev, k17rev, k18rev, k19rev):
    # IL2 in nM
    IL2Ra = y[0]
    IL2Rb = y[1]
    gc = y[2]
    ...
    # The receptor-receptor forward rate is largely going to be determined by
    # plasma membrane diffusion so we're going to assume it's shared.
